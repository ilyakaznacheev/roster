...
// NewGetRostersIDParams creates a new GetRostersIDParams object
// no default values defined in spec.
func NewGetRostersIDParams() GetRostersIDParams {

	return GetRostersIDParams{}
}

// GetRostersIDParams contains all the bound params for the get rosters ID operation
...
func (o *GetRostersIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
