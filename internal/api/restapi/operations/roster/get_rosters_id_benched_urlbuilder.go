...
func (o *GetRostersIDBenchedURL) WithBasePath(bp string) *GetRostersIDBenchedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRostersIDBenchedURL) Build() (*url.URL, error) {
	...
	var _path = "/rosters/{id}/benched"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetRostersIDBenchedURL")
	}
...
func (o *GetRostersIDBenchedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRostersIDBenchedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRostersIDBenchedURL")
	}
